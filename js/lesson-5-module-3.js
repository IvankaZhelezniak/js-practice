...
// ПРИМЕР ещё лучше 
// Вот мы делаем keys это массив, теперь мы делаем обычный перебор массивf циклом for
...
// деоаем массив его ключей) и на каждой итерации мы получаем доступ к их значениям
